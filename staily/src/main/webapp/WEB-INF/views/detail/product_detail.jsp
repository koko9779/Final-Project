					...
					<div id="three">
						<c:if test="${not empty userNo}">
							<form id="userReply" method="POST">
								${userId}<br> <input type="text" id="rContent"> <input
									type="hidden" id="mNo"> <input type="hidden" value="0"
									id="rRecommend"> <input type="hidden" value="0"
									id="rRecommend"> <input type="button" value="작성"
									id="createreply">
							</form>
						</c:if>
						<p id="replyList"></p>
